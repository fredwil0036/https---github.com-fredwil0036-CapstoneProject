...
class StaffweathershowController extends Controller
{
    ...
    {
        $city = $request->input('city', 'San Manuel,Pangasinan, Philippines'); // Default to Sta Barbara, Philippines
        ...
        return view('staff.staffpages.weatherShow', compact('currentWeather', 'filteredForecast','Hourlyforecast'));
    }
